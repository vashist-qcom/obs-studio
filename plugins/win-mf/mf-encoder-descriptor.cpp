...
struct EncoderEntry {
	...
	{
		"{7790EE16-08E3-426D-AADA-F96774308EA1}",
		"MF.H264.EncoderHWQCOM",
		"qcom_h264",
		EncoderType ::H264_QCOM
	},
	{
		"{5AAFFE75-4EA4-424C-89E3-4A1E3F9A570D}",
		"MF.HEVC.EncoderHWQCOM",
		"qcom_hevc",
		EncoderType :: HEVC_QCOM
	},
	{
		"{0705AB91-0EC9-4D51-90E2-00C3360F41C4}",
		"MF.AV1.EncoderHWQCOM",
		"qcom_av1",
		EncoderType :: AV1_QCOM
	}
};
...
std::vector<std::shared_ptr<EncoderDescriptor>>
EncoderDescriptor::Enumerate(const char Codec[])
{
	HRESULT hr;
	UINT32 count = 0;
	...
	//// Now repeat the process for MFVideoFormat_HEVC
	//info.guidSubtype = MFVideoFormat_HEVC;

	//hr = MFTEnumEx(MFT_CATEGORY_VIDEO_ENCODER, unFlags, NULL, &info,
	//	       &ppActivate, &count);
